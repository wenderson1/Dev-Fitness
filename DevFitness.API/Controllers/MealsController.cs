    ...
    public class MealsController : ControllerBase
    {
        ...
        public IActionResult GetAll(int userId)
        {
            ...
            var allMealsViewModels = allMeals
                .Select(m=> new MealViewModel(m.Id, m.Description, m.Calorias, m.Date));
        ...
        public IActionResult Get(int userId, int mealId)
        {
            ...
            //var mealViewModel = new MealViewModel(meal.Id, meal.Description, meal.Calorias, meal.Date);
        ...
        {
            //var meal = new Meal(inputModel.Description, inputModel.Calorias, inputModel.Date, userId);
        ...
        public IActionResult Put(int userId, int mealId, [FromBody] UpdateMealInputModel inputModel)
        {
            ...
            meal.Update(inputModel.Description, inputModel.Calorias, inputModel.Date);
            _dbContext.SaveChanges();
            return NoContent();
        }
